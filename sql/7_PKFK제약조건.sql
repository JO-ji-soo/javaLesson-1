...
- 성적테이블에 '과목명'을 학생 1명이 동일한 과목을 수강한다면(예를 들면 1학년 국어 ,  2학년 국어, 3학년 국어 )
  ...
  2) '과목'테이블 - 과목코드(PK=기본키), 과목명(중복허용 가능), 담당교사(중복허용 가능)
...
SELECT * FROM TBL_SCORE ORDER BY SUBJECT=과학;
